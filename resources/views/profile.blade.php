            ...
            <div class="bg-gray-50 border border-gray-200 shadow-md p-10 rounded max-w-lg mx-auto mt-24">
                ...
                <form action="/user/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-red-500 test-xs mt-1">{{$message}}</p>
                        @enderror  
                        <p class="text-xs text-slate-900 flex  mt-2"><svg xmlns="http://www.w3.org/2000/svg" class="mr-1" x="0px" y="0px" width="18" height="18" viewBox="0 0 50 50">
                    ...
                    <div class="mb-6">
                        ...
                        <a href="/" class="border-laravel border text-black ml-4 rounded py-2 px-4 hover:bg-laravel2 text-lg">
                            Annuler
                        </a>
                    </div>
                </form>
